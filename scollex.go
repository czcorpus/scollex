...
func main() {
	...
	coOccurenceSpan := importCmd.Int("colloc-flags-with-span", 2, "Defines window size for calculating coocurrences")
	...
	case "import":
		...
		err = engine.RunPg(importCmd.Arg(1), importCmd.Arg(2), *coOccurenceSpan, &corpProps.Syntax, sqlDB)
		if err != nil {
